...
const EMPTY_RESUME = {
  ...
  experience: [
    { company: "", role: "", location: "", duration: "", points: "" },
  ],
  education: [
    {
      institution: "",
    ...
    <>
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            Fill in your details, preview and download as a clean PDF.{" "}
          ...
          >
            <button
              ...
              style={{
                ...
                gap: 7,
                padding: "10px 20px",
                background: preview ? "#4F46E5" : "#FFFFFF",
                border: "1px solid #E2E6F0",
                borderRadius: 10,
                color: preview ? "#FFFFFF" : "#0B132B",
                fontFamily: "Poppins",
                fontSize: 13,
                fontWeight: 600,
                cursor: "pointer",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {form.linkedin && (
                    <span>linkedin.com/in/{form.linkedin}</span>
                  )}
              ...
              {form.skillCategories.some(
                (c) => c.category || c.skills
              ) && (
                <div style={{ marginBottom: 16 }}>
                  <h2
                    style={{
          ...
          {!preview && (
            ...
            >
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    placeholder: "AnilBhukya05",
                  },
                  {
                    field: "portfolio",
                    label: "Portfolio URL",
                    placeholder: "anilbhukya.dev",
                  },
                ].map((f) => (
                  <div key={f.field}>
              ...
              {form.experience.map((exp, i) => (
                <div key={i} style={cardStyle}>
                  ...
                  >
                    {[
                      ...
                      <input
                        ...
                        value={exp[f.field]}
                        onChange={(e) =>
                          setExp(i, f.field, e.target.value)
                        }
                        placeholder={f.placeholder}
                        style={inputStyle}
                        onFocus={(e) => {
                  ...
                  <textarea
                    value={exp.points}
                    onChange={(e) =>
                      setExp(i, "points", e.target.value)
                    }
                    placeholder={
                      "Built and shipped X using React.js and Tailwind CSS\nDeveloped Y improving Z by N%\nOwned the project end-to-end"
                    }
                    rows={4}
                    style={{
                      ...inputStyle,
                ...
                <div key={i} style={cardStyle}>
                  ...
                  >
                    {[
                      ...
                      {
                        field: "year",
                        placeholder: "Nov 2021 – July 2025",
                      },
                      {
                        field: "grade",
                        placeholder: "CGPA: 8.68/10",
                      },
                    ].map((f) => (
                      <input
                        key={f.field}
                        value={edu[f.field]}
                        onChange={(e) =>
                          setEdu(i, f.field, e.target.value)
                        }
                        placeholder={f.placeholder}
                        style={inputStyle}
                        onFocus={(e) => {
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEdu(i, "coursework", e.target.value)
                    }
                ...
                <div key={i} style={cardStyle}>
                  ...
                  >
                    <input
                      value={cat.category}
                      onChange={(e) =>
                        setSkillCat(i, "category", e.target.value)
                      }
                    ...
                    <input
                      value={cat.skills}
                      onChange={(e) =>
                        setSkillCat(i, "skills", e.target.value)
                      }
                      placeholder="React.js, JavaScript (ES6+), HTML5, CSS3, Tailwind CSS"
                      style={inputStyle}
                      onFocus={(e) => {
                        e.currentTarget.style.borderColor = "#4F46E5";
                        e.currentTarget.style.boxShadow =
                ...
                <div key={i} style={cardStyle}>
                  ...
                  >
                    <input
                      value={proj.github}
                      onChange={(e) =>
                        setProj(i, "github", e.target.value)
                      }
                  ...
                  <textarea
                    value={proj.points}
                    onChange={(e) =>
                      setProj(i, "points", e.target.value)
                    }
                    placeholder={
                      "Built a centralized job aggregation platform...\nImplemented advanced search and filtering functionality..."
                    }
                    rows={3}
                    style={{
                      ...inputStyle,
              ...
              <textarea
                ...
                placeholder={
                  "React JS – Core frontend concepts including component-based architecture, props, and hooks — Scaler\nJava Programming – Covered Java basics — Coursera"
                }
                rows={3}
                style={{
                  ...inputStyle,
              ...
              <textarea
                ...
                onChange={(e) =>
                  set("publications", e.target.value)
                }
                placeholder={
                  "Face Recognition-Based Attendance System Using KNN Algorithm — IEEE 3rd ICAISS, 2025. DOI: 10.1109/ICAISS61471.2025.11042050"
                }
                rows={2}
                style={{
                  ...inputStyle,
              ...
              <textarea
                ...
                onChange={(e) =>
                  set("achievements", e.target.value)
                }
                placeholder={
                  "Certificate of Merit – Naukri Campus Young Turks 2025, secured 95.22 percentile\nEvent Organizer – College-Level Events"
                }
                rows={3}
                style={{
                  ...inputStyle,
