...
function EmptySection({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-base font-semibold text-[#0B132B]">
        {title}
      </h3>
  ...
  async function loadProfile() {
    try {
      ...
      setProfile({
        ...
        educationDetails: Array.isArray(
  ...
  async function deleteItem(type, index) {
    ...
    if (type === "education") {
      updatedProfile.educationDetails =
        profile.educationDetails.filter(
          (_, i) => i !== index
        );
    }
  ...
  return (
    <>
            ...
            >
                ...
                {profile.resume ? (
                  ...
                  <div className="rounded-xl border border-dashed border-[#D8DEEA] bg-[#F8FAFF] p-8 text-center">
                    ...
                    <motion.button
                      ...
                      className="mt-4 cursor-pointer rounded-xl bg-[#4F46E5] px-5 py-2.5 text-sm font-bold text-white"
                    >
                      Add Resume
                    </motion.button>
                  </div>
              ...
              >
                <p className="mb-5 text-xs text-[#64748B]">
                  Used for job matching. Not shown
      ...
      >
        ...
        <p className="mt-2 text-xs text-[#64748B]">
          Add up to 5 cities separated by
          commas.
        </p>
      </EditModal>
      ...
      >
        ...
        <p className="mt-2 text-xs text-[#64748B]">
          Paste a direct video link from cloud
          storage or a hosted MP4.
        </p>
      </EditModal>
    </>
  );
